import { parseSemanticVersion, toStableVersion, } from "./version.js";
export function createNMinusRangeSupportPolicy(latestReleaseVersion, majorRange, minorRange) {
    return new NMinusRangeSupportPolicy(parseSemanticVersion(latestReleaseVersion), majorRange, minorRange);
}
// N-{{range}} policy on minor and major
export class NMinusRangeSupportPolicy {
    latestVersion;
    majorRange;
    minorRange;
