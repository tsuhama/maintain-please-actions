...
async function analyze(options) {
  ...
  const eslintExtensions = eslintConfig.extensions || ['.cjs', '.cts', '.js', '.jsx', '.ts', '.tsx', '.mjs', '.mts', '.vue', '.svelte'];
  ...
  if (['.svelte'].includes(fileExtension)) {
    var _formattingOptions$es3;
    (_formattingOptions$es3 = formattingOptions.eslint).parser || (_formattingOptions$es3.parser = require.resolve('svelte-eslint-parser'));
  }
